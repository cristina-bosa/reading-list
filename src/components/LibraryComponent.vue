<template>
  ...
  <section arial-label="library" class="library">
    <article class="single-book" v-for="book in library" v-bind:key="book.book.ISBN">
      <BookComponent :book="book.book"></BookComponent>
    </article>
  </section>
</template>
